...
- **Tests**: four self-contained smoke harnesses stub the host globals and assert the
  ...
  - `lua blademaster_test.lua` — run from inside `ports/legacy_ak/blademaster/` (uses `dofile("blademaster.lua")`); asserts decision parity with Levi 005.
